...
def render_page4():
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            html.Hr(),
            html.Label("🚫 Custom Stopwords"),
            dcc.Store(id="stopwords-store", data=[]),
            dbc.Card([
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col(
                            dcc.Input(
                                ...
                                style={"width":"100%","borderRadius":"8px",
                                       "border":"1px solid #cbd5e0","padding":"8px 12px"},
                            ), width=9,
                        ),
                        dbc.Col(
                            dbc.Button("+ Add", id="btn-add-stopword",
                                       color="secondary", size="sm",
                                       style={"width":"100%"}),
                            width=3,
                        ),
                    ], className="mb-2"),
                    html.Div(id="stopwords-chips",
                             style={"minHeight":"36px","display":"flex",
                                    "flexWrap":"wrap","gap":"6px"}),
                    dcc.Input(id="stopwords-hidden", type="hidden", value=""),
                ]),
